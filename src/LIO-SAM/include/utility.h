...
public:
    ...
    // Save robot pose csv
    bool saveRobotPoseCsv;
    string robotPoseCsvDirectory;
    ...
    ParamServer()
    {
        ...
        nh.param<bool>("lio_sam/saveRobotPoseCsv", saveRobotPoseCsv, true);
        nh.param<std::string>("lio_sam/robotPoseCsvDirectory", robotPoseCsvDirectory, "/home/yyh/study_files/Compare_deeppvslam/src/LIO-SAM/Robotpose/1005_01");
